...
import (
	...
	"github.com/gkwa/fewduck/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fewduck.yaml)")
